...
struct Event {
    ...
    init(addedByUser: String, name:String, time:String, address:String, latitude:String, longitude:String, invitees:[String]){
    ...
    init(snapshot: FIRDataSnapshot) {
        ...
        invitees = snapshotValue["invitees"] as! [String]
        ref = snapshot.ref
    }
